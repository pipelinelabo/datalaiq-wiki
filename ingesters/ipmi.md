...
The IPMI ingester uses the unified global configuration block described in the [ingester section](#!ingesters/ingesters.md#Global_Configuration_Parameters).  Like most other DatalaiQ ingesters, the IPMI ingester supports multiple upstream indexers, TLS, cleartext, and named pipe connections, a local cache, and local logging.
...
Additionally, all IPMI stanzas can use the "Preprocessor" options, as described [here](https://doc.datalaiq.io/#!ingesters/preprocessors/preprocessors.md).
