...
The Direct Query API is authenticated and requires a valid DatalaiQ account with access to the DatalaiQ query system.  Most users will want to generate a [DatalaiQ Token](/tokens/tokens) and use that to access the query API.
